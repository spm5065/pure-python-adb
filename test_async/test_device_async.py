...
class TestDevice(unittest.TestCase):
    ...
    async def test_shell(self):
        with async_patch(
            ...
            with async_patch(
                "{}.FakeStreamReader.read".format(__name__),
                side_effect=[b"OKAY", b"OKAY", b"test", b"", b"OKAY"],
            ):
    ...
    async def test_shell_error(self):
        with async_patch(
            ...
            with async_patch(
                "{}.FakeStreamReader.read".format(__name__), return_value=b"FAIL"
            ):
    ...
    async def test_screencap(self):
        with async_patch(
            ...
            with async_patch(
                "{}.FakeStreamReader.read".format(__name__),
                side_effect=[b"OKAY", b"OKAY", PNG_IMAGE, b"", b"OKAY"],
            ):
        ...
        with async_patch(
            ...
            with async_patch(
                "{}.FakeStreamReader.read".format(__name__),
                side_effect=[b"OKAY", b"OKAY", PNG_IMAGE_NEEDS_REPLACING, b"", b"OKAY"],
            ):
                self.assertEqual(await self.device.screencap(), PNG_IMAGE)
